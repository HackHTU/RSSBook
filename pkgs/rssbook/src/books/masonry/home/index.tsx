					...
					<main>
						<div class="mx-auto max-w-7xl px-4 pt-8 sm:px-6 lg:px-8">
							<div class="flex items-center justify-between">
								<div>
									<p class="font-medium text-stone-400 text-xs uppercase tracking-widest dark:text-stone-500">
										<span>
						...
						<Grid filter={filterInfo} items={items} t={t} />

				...
				<div class="flex flex-col items-center justify-between gap-4 md:flex-row">
					<div class="flex items-center gap-3">
						<div class="flex items-center gap-2">
							...
							<span class="font-medium text-sm text-stone-600 dark:text-stone-400">
					...
					<div class="flex items-center gap-3 text-sm text-stone-600 dark:text-stone-400">
						...
						<span safe>{t.of}</span>
						<span class="font-bold text-stone-900 dark:text-stone-100">{safeTotalPages}</span>
					...
					<div class="flex items-center gap-2">
						...
						>
							<svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
								<title safe>{t.previousPage}</title>
								<path
									d="M15 19l-7-7 7-7"

...
export const openAPIPlugin = (enableFetchOnlineServer: boolean = true) => {
	...
	return new Elysia({ name: "RSSBook/OpenAPI" }).use(
		openapi({
			documentation: {
				info: {
					contact: {
...
`,
				...
				tags: [
					...
					{
						description: "**Academic, scientific, and technical research** materials and studies.",
						name: "research",
					},
					{
						description:
					...
					{
						description: "RSSBook related endpoints, including theme, documentation and metadata.",
						name: "_",
					},
				],
			},

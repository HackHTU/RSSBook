...
export function Item({ item }: Item) {
	...
	return (
		<article class="group relative">
			<div class="-left-13 absolute top-8 hidden md:block">
				<div class="relative">
					<div class="-translate-y-1/2 absolute top-1/2 left-1/2 h-[2px] w-8 bg-gradient-to-r from-rose-500/50 to-rose-400/30 dark:from-rose-700/50 dark:to-rose-600/30"></div>
			...
			<div class="hover:-translate-y-1 relative overflow-hidden rounded-3xl bg-white/80 shadow-rose-100/50 shadow-sm ring-1 ring-stone-200/50 backdrop-blur-xl transition-all duration-300 hover:scale-[1.02] hover:shadow-lg hover:shadow-rose-200/60 dark:bg-stone-900/80 dark:shadow-rose-900/50 dark:ring-stone-800/50 dark:hover:shadow-rose-950/30">
